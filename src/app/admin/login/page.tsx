...
export default function AdminLoginPage() {
  ...
  const [isLogin, setIsLogin] = useState(true); // Always true for admin
  ...
  const handleGoogleSignIn = () => {
    startTransition(async () => {
      // Not allowed for admins in this demo
      setError("Google sign-in is disabled for admins");
    });
  };
